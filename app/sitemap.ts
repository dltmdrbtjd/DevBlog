...
import { getAllCategory, getSortedPostsData } from '@/src/entities/post';
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const categoryPages: MetadataRoute.Sitemap = categories.flatMap(({ category, count }) => {
  ...
  return [...staticPages, ...postPages, ...postPaginationPages, ...categoryPages];
}
